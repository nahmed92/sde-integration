...
public class StandardizedParameterPojoTest {

    @Test
    public void shouldFollowEqualsContract() {
        EqualsVerifier.forClass(StandardizedParameter.class) //
    ...
    public void hasToString() {
        final StandardizedParameter param = new StandardizedParameter("1", "value",
                "unit", false);
