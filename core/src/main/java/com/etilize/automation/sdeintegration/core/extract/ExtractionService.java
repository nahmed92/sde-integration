...
/**
 * Extraction Service for extracting and standardizing the extracted values
 *
 * @author Faisal Feroz
 *
 */
public interface ExtractionService {
    ...
    /**
     * Performs data extraction and standardization of the extracted parameters from the
     * data sent in {@link ExtractionRequest}
     *
     * @param request
     * @return
     */
